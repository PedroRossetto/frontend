...
var Senha = /*#__PURE__*/_createClass(function Senha() {
  _classCallCheck(this, Senha);
  _defineProperty(this, "quantidade", this.quantidade);
  _defineProperty(this, "numeros", this.numeros);
  _defineProperty(this, "upper", this.upper);
  _defineProperty(this, "lower", this.lower);
  _defineProperty(this, "simbol", this.simbol);
  _defineProperty(this, "senha", this.senha);
});
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_Senha__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/Senha */ "./src/modules/Senha.js");
